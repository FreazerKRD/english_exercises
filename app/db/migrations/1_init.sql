...
INSERT INTO books (file_name) VALUES ('Little_Red_Cap_ Jacob_and_Wilhelm_Grimm.json'), ('Little_Red_Riding_Hood_Charles_Perrault.json') ON CONFLICT (file_name) DO NOTHING;